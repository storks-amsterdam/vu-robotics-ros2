...
This is the recommended approach if you have a computer running Ubuntu 24.04 with sufficient resources (recommended: 4-core/8-thread CPU, 16GB RAM).
...
This tutorial, adapted from the official ROS 2 documentation, guides you through creating a simple publisher and subscriber.
...
Create a file for the publisher node:
```bash
